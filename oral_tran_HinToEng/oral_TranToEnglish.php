...
// Load Hindi sentences and answers
...
<div class="container">
  ...
  <form method="post" action="oral_submit_TanToEng.php" id="oralForm">
    <?php foreach ($selected as $i => $item): ?>
      <div class="slide" id="slide<?= $i ?>">
        ...
        <!-- FIXED: input name changed from responseX to answerX -->
        <input type="text" name="answer<?= $i ?>" id="answer<?= $i ?>" placeholder="Speak your English translation here..." readonly>
        <div class="controls">
