...
$filePath = "AppData/Translations/EnglishSentences.txt";
if (!file_exists($filePath)) die("English sentence file missing.");

$sentences = array_filter(array_map('trim', file($filePath)));
shuffle($sentences);
$selected = array_slice($sentences, 0, 10);
$_SESSION['trans_mode'] = 'E2H';
    ...
    <form action="submit_translation.php" method="POST">
        <?php foreach ($selected as $i => $sentence): ?>
            <div class="slide" id="slide<?= $i ?>">
                ...
                <input type="text" name="answer<?= $i ?>" placeholder="Type Hindi translation here..." />
